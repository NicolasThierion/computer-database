...
public interface IComputerDao {
    ...
    /**
     * List computers with name matching given 'name' parameter. Order results by name.
     * @param offset Search offset.
     * @param nb Number of results to fetch. Set a negative value for unbounded search.
     ...
     * @param offset Search offset.
     * @param nb Number of results to fetch. Set a negative value for unbounded search.
     * @param name Computer name to search for, non case sensitive.
     * @throw IllegalArgumentException if name is invalid (ie : empty) or if search offset is negative
     * @return the list of results.
     */
