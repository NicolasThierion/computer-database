...
public class Page<T> {
	 ...
	 * CONSTRUCTORS
	 */
	private void newPage(List<T> content, int pageNum, int offset, int maxResults, String queryString) {
		mPageNum = pageNum;
	...
	public Page (List<T> content, int pageNum, int offset, int maxResults, String queryString) {
	...
	public void setContent(List<T> mContent) {
	...
	public void setQueryString(String mQueryString) {
